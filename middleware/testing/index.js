...
function publishTwoMqttRandomPayloadsPeriodically(brokerUrl, topic, intervalMs, options = {}) {
    ...
    client.on('connect', () => {
        ...
        setInterval(() => {
            ...
            const payload1 = {
                "DataTRB245": [
                    {"data": getRandomNumber(1.0, 10.0, 2), "name": "Flowmeter1"},
                    {"data": getRandomNumber(0.1, 1.0, 3), "name": "Totalizer1"},
                    {"data": getRandomNumber(5.0, 20.0, 2), "name": "Velocity1"}
                ]
            };
            ...
            const payload2 = {
                "DataTRB245": [
                    {"data": getRandomNumber(1.0, 10.0, 2), "name": "Flowmeter2"},
                    {"data": getRandomNumber(0.1, 1.0, 3), "name": "Totalizer2"},
                    {"data": getRandomNumber(5.0, 20.0, 2), "name": "Velocity2"}
                ]
            };
...
const publishInterval = 5000;                 // 5000 milidetik = 5 detik
